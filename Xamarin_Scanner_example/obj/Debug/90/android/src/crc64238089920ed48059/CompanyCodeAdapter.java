...
public class CompanyCodeAdapter
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Xamarin_Scanner_example.CompanyCodeAdapter, Xamarin_Scanner_example", CompanyCodeAdapter.class, __md_methods);
	}


	public CompanyCodeAdapter ()
	{
		super ();
		if (getClass () == CompanyCodeAdapter.class) {
			mono.android.TypeManager.Activate ("Xamarin_Scanner_example.CompanyCodeAdapter, Xamarin_Scanner_example", "", this, new java.lang.Object[] {  });
		}
	}
