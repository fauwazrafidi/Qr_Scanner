...
public class SearchableSpinnerAdapter
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Xamarin_Scanner_example.SearchableSpinnerAdapter, Xamarin_Scanner_example", SearchableSpinnerAdapter.class, __md_methods);
	}


	public SearchableSpinnerAdapter ()
	{
		super ();
		if (getClass () == SearchableSpinnerAdapter.class) {
			mono.android.TypeManager.Activate ("Xamarin_Scanner_example.SearchableSpinnerAdapter, Xamarin_Scanner_example", "", this, new java.lang.Object[] {  });
		}
	}
